          ...
          <div className="mt-6 flex justify-end space-x-4">
            ...
            {isCompleted ? (
              <button
                ...
                className="px-4 py-2 rounded-md text-white bg-gray-500 hover:bg-gray-600 dark:bg-gray-400 dark:hover:bg-gray-500"
              >
                Update Workout
              </button>
            ) : (
              <button
                ...
                className="px-4 py-2 rounded-md text-white bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-400 dark:hover:bg-indigo-300"
              >
                Start Workout
              </button>
            )}
